...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT Email FROM sysadmin WHERE EMAIL=:email and MOBILE_NUMBER=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update sysadmin set PASSWORD=:newpassword where EMAIL=:email and MOBILE_NUMBER=:mobile";
...
<!DOCTYPE html>
<head>
<title>Padi's Kitchen Delight | Forgot Page </title>
...
<body class="signup-body">
		<div class="agile-signup">	
			...
			<!-- footer -->
			<div class="copyright">
				<p>Padi's Kitchen Delight @ 2022</p>
			</div>
			<!-- //footer -->
