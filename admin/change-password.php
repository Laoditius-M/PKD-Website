...
$sql ="SELECT ID FROM sysadmin WHERE ID=:adminid and PASSWORD=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update sysadmin set PASSWORD=:newpassword where ID=:adminid";
...
<!DOCTYPE html>
<head>
<title>Padi's Kitchen Delight | Change Password</title>
