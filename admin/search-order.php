...
<!DOCTYPE html>
<head>
<title>Padi's Kitchen delight | Search Order</title>
...
$sql="SELECT * from orders where ORDER_NUMBER like '$sdata%' LIMIT $offset, $no_of_records_per_page";
